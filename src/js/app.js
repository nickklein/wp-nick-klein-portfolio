...
var expertise = require('./modules/expertise');
var three_col_grid = require('./modules/three_col_grid');
...
},{"./modules/expertise":18,"./modules/footer":19,"./modules/header":20,"./modules/three_col_grid":21,"jquery":11}],18:[function(require,module,exports){
'use strict';
...
},{"../../../node_modules/waypoints/lib/jquery.waypoints.js":16,"slick-carousel":15}],21:[function(require,module,exports){
'use strict';
...
module.exports = {
	init: function init(self) {
		console.log('three_col_grid');
		this.bind();
	},
	bind: function bind() {
		var $grid = new Isotope('.iso-container', {
			// options
